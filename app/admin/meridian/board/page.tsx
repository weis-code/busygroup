...
export default function MeridianBoardPage() {
  return (
    <div style={{ padding: '28px 32px' }}>
      <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--t1)', marginBottom: 4 }}>Meridian Board</h1>
      <p style={{ fontSize: 12, color: 'var(--t3)', marginBottom: 24 }}>Projektstyring for Meridian</p>
