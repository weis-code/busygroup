    ...
    <div style={{ padding: '28px 32px', maxWidth: 900 }}>
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
          <div style={{ width: 32, height: 32, borderRadius: 8, background: 'var(--gr2)', border: '1.5px solid rgba(45,212,160,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 800, color: ACCENT }}>AI</div>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--t1)' }}>AI Receptionist — oversigt</h1>
        </div>
        <p style={{ fontSize: 12, color: 'var(--t3)' }}>Meridian Consulting · Flagskibsprodukt</p>
      </div>
      ...
      <div style={{ background: 'var(--s1)', border: '1px solid var(--bd)', borderRadius: 10 }}>
        <div style={{ padding: '14px 18px', borderBottom: '1px solid var(--bd)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--t1)' }}>Kunder med AI Receptionist</span>
        ...
        {!stats ? (
          ...
          <div style={{ padding: '40px 20px', textAlign: 'center', color: 'var(--t3)', fontSize: 13 }}>Ingen AI Receptionist kunder endnu</div>
        ) : (
