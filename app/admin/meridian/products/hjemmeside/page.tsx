...
export default function HjemmesideProductPage() {
    ...
    <div style={{ padding: '28px 32px', maxWidth: 900 }}>
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
          <div style={{ width: 32, height: 32, borderRadius: 8, background: 'var(--bl2)', border: '1.5px solid rgba(79,142,247,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 800, color: ACCENT }}>WB</div>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--t1)' }}>Hjemmeside — oversigt</h1>
        </div>
        <p style={{ fontSize: 12, color: 'var(--t3)' }}>Meridian Consulting · Webdesign & hosting</p>
      </div>
      ...
      <div style={{ background: 'var(--s1)', border: '1px solid var(--bd)', borderRadius: 10 }}>
        <div style={{ padding: '14px 18px', borderBottom: '1px solid var(--bd)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--t1)' }}>Kunder med Hjemmeside</span>
        ...
        {!stats ? (
          ...
          <div style={{ padding: '40px 20px', textAlign: 'center', color: 'var(--t3)', fontSize: 13 }}>Ingen Hjemmeside kunder endnu</div>
        ) : (
